  ...
  Widget build(BuildContext context) {
    ...
    final userStats = Positioned(
      ...
      child: Row(
        ...
        children: <Widget>[
          _buildUserStats('EVENTOS', '2305'),
          _buildUserStats('SEGUIDORES', '276'),
          _buildUserStats('ESTRELAS', '4.2/5'),
        ],
      ),
    );
    ...
    final thirdCard = Padding(
      ...
      child: Material(
        ...
        child: Container(
          ...
          child: Column(
              children: <Widget>[
              _buildIconTile(Icons.favorite, Colors.red, 'Roles Criados'),
              hr,
              _buildIconTile(LineIcons.eye, Colors.green, 'Roles Frequentados'),
            ],
          ),
        ),
      ),
